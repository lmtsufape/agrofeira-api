...
import br.com.ecofeira.dto.ClienteDTO
import br.com.ecofeira.service.ClienteService
...
class ClienteController(
    ...
    @PostMapping
    fun criar(@RequestBody cliente: Cliente) =
        ResponseEntity.ok(ClienteDTO.from(clienteService.criar(cliente)))

    @PutMapping("/{id}")
    fun atualizar(@PathVariable id: String, @RequestBody cliente: Cliente) =
