...
import br.com.ecofeira.dto.PagamentoDTO
import br.com.ecofeira.service.PagamentoService
...
class PagamentoController(
    ...
    fun listarPorPedido(@PathVariable pedidoId: String) =
        ResponseEntity.ok(
    ...
    @PostMapping
    fun registrar(@RequestBody request: RegistrarPagamentoRequest) =
        ResponseEntity.ok(PagamentoDTO.from(
