...
import br.com.ecofeira.dto.FeiraDTO
import br.com.ecofeira.service.FeiraService
import org.springframework.http.ResponseEntity
import org.springframework.web.bind.annotation.*
import br.com.ecofeira.dto.FeiraComercianteDTO
...
class FeiraController(
    ...
    @PostMapping
    fun criar(@RequestBody request: CriarFeiraRequest) =
        ResponseEntity.ok(FeiraDTO.from(
            feiraService.criar(request.feira, request.comercianteIds, request.itemIds)
        ))

    @PatchMapping("/{id}/status")
    fun atualizarStatus(@PathVariable id: String, @RequestBody status: StatusFeira) =
    ...
    fun buscarFeiraComerciantePorFeiraEComerciante(
        ...
        feiraService.buscarFeiraComerciantePorFeiraEComerciante(feiraId, comercianteId)
