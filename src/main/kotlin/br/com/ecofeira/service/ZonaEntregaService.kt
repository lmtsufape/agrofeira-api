...
import br.com.ecofeira.domain.repository.ZonaEntregaRepository
...
class ZonaEntregaService(
    ...
    fun buscarPorBairro(bairro: String): ZonaEntrega? =
        zonaEntregaRepository.findByBairroIgnoreCase(bairro)

    @Transactional
    fun criar(zonaEntrega: ZonaEntrega): ZonaEntrega =
        zonaEntregaRepository.save(zonaEntrega)

    @Transactional
    fun atualizar(id: String, zonaEntrega: ZonaEntrega): ZonaEntrega {
