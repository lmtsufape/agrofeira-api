...
import br.edu.ufape.agrofeira.service.EstoqueBancaService
...
class EstoqueBancaController(
    ...
    @PostMapping
    fun declarar(
        @RequestBody request: DeclararEstoqueRequest,
    ) = ResponseEntity.ok(
        EstoqueBancaDTO.from(
    ...
    fun atualizar(
        @PathVariable id: String,
        @RequestBody request: AtualizarEstoqueRequest,
