...
import br.edu.ufape.agrofeira.dto.EstoqueBancaDTO
import br.edu.ufape.agrofeira.dto.PedidoDTO
...
class PedidoController(
    ...
    fun consultarRateio(
        ...
        pedidoService
            .consultarDisponibilidadeParaRateio(id)
    ...
    fun confirmarRateio(
        @PathVariable id: String,
        @RequestBody request: RateioRequest,
    ) = ResponseEntity.ok(
        PedidoDTO.from(
            pedidoService.confirmarRateio(
                pedidoId = id,
                rateio =
                    request.rateio.mapValues { (_, alocacoes) ->
    ...
    fun atualizarStatus(
        @PathVariable id: String,
        @RequestBody status: StatusPedido,
