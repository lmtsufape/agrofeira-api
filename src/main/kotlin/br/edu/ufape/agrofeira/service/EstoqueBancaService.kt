...
class EstoqueBancaService(
    ...
    fun listarPorFeira(feiraId: String): List<EstoqueBanca> =
        estoqueBancaRepository
            .findByFeiraComercianteEntityFeiraIdAndItemId(feiraId, "")
            .let {
                estoqueBancaRepository
                    .findAll()
    ...
    fun listarPorFeiraEItem(
        feiraId: String,
        itemId: String,
    ): List<EstoqueBanca> = estoqueBancaRepository.findDisponiveisPorFeiraEItemOrdenadoPorMenosVendido(feiraId, itemId)
